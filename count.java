...
public static void main(String[] args) {
	...
	JavaRDD<String> rdd = jsc.textFile("data/Brightkite_edges.txt");
	...
	long tempoZero = System.currentTimeMillis();
	...
	long tempoImpiegato = System.currentTimeMillis() - tempoZero;
	double secondi = (double)tempoImpiegato/1000;
	System.out.println("Tempo impiegato (millisecondi): " + tempoImpiegato);
